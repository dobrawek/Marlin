...
# Relocate firmware from 0x08000000 to 0x08020000
env['CPPDEFINES'].remove(("VECT_TAB_ADDR", "0x8000000"))
env['CPPDEFINES'].append(("VECT_TAB_ADDR", "0x08020000"))

custom_ld_script = os.path.abspath("buildroot/share/PlatformIO/variants/QIDI_XMAX/ldscript.ld")
...
# Encrypt ${PROGNAME}.bin and save it as 'update.qd'
def encrypt(source, target, env):
    firmware = open(target[0].path, "rb")
    update = open(target[0].dir.path +'/update.qd', "wb")
